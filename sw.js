const CACHE='dgos-personal-shell-25';
const ASSETS=['./','./index.html','./styles.css?v=0.45.3','./wow.css?v=0.37.1','./personal.css?v=0.51.0','./social.css?v=0.45.3','./navigation.css?v=0.51.0','./mobile.css?v=0.46.3','./personal.js?v=0.51.0','./social.js?v=0.45.3','./navigation.js?v=0.46.0','./weather.js?v=0.46.2','./marketBrain.js','./app.js?v=0.46.3','./manifest.webmanifest','./icon-192.png','./icon-512.png',
