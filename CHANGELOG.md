...
## Verbessert
- Neuer „Social“-Button in der unteren DG-OS-Navigation.
- Ein Tipp auf „Social“ öffnet direkt den Social Media Hub, statt nur zur Social-Karte zu scrollen.
- Navigation bleibt im bestehenden Glass-/Jarvis-Stil und funktioniert auch mobil mit fünf Hauptbereichen.

## Unverändert
- Keine Änderungen an Trading Brain, Market Brain, Trading-Regeln oder Instagram-Cleanup-Logik.

# v0.45.0 — Social Media Hub & Instagram Cleanup\n\n## Neu\n- Neuer Social Media Hub direkt im persönlichen DG-OS-Bereich.\n- Zwei vollständig getrennte Instagram-Profile: Business und Privat.\n- Instagram-Username pro Profil lokal speicherbar, ohne Instagram-Passwort.\n- Import des entpackten Instagram-Datenexports (Followers + Following, JSON oder HTML).\n- Automatischer Vergleich: Following, Followers und Accounts, die nicht zurückfolgen.\n- Whitelist für Accounts, die beim Cleanup immer geschützt bleiben.\n- Smart-Cleanup-Queue: Instagram-Profil öffnen, danach Behalten / Entfernt / Später markieren.\n- Cleanup-Fortschritt und Entscheidungen werden pro Profil lokal im Browser gespeichert.\n- Glassmorphism-Oberfläche passend zum aktuellen DG-OS/Jarvis-Design, inklusive Mobile-Ansicht.\n\n## Datenschutz & Sicherheit\n- Keine Instagram-Zugangsdaten werden abgefragt oder gespeichert.\n- Importierte Follower-/Following-Listen bleiben im Browser-localStorage.\n- Kein automatisiertes Entfolgen und kein Umgehen von Instagram-Schutzmechanismen.\n- Die tatsächliche Unfollow-Aktion erfolgt bewusst manuell auf Instagram.\n\n## Unverändert\n- Keine Änderungen an Trading Brain, Market Brain, Trading-Regeln, LiveUP, Trading Academy oder Prestige.\n\n## Geänderte/Neue Dateien\n- index.html\n- social.css (neu)\n- social.js (neu)\n- sw.js\n- package.json\n- README.md\n- CHANGELOG.md\n\n# v0.44.1 — WHOOP OAuth setup pages
