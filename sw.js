const CACHE='dgos-personal-shell-15';
const ASSETS=['./','./index.html','./styles.css?v=0.45.3','./wow.css?v=0.37.1','./personal.css?v=0.45.3','./social.css?v=0.45.3','./navigation.css?v=0.46.0','./personal.js?v=0.45.3','./social.js?v=0.45.3','./navigation.js?v=0.46.0','./weather.js','./marketBrain.js','./app.js?v=0.45.3','./manifest.webmanifest','./icon-192.png','./icon-512.png',
