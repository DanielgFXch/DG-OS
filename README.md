...
\n\n## Social Media Hub\n\nDG OS enthält einen lokalen Social Media Hub für zwei getrennte Instagram-Profile (Business und Privat). Der Cleanup arbeitet ohne Instagram-Passwort: Nach dem Download des eigenen Instagram-Datenexports werden die entpackten Followers- und Following-Dateien (JSON oder HTML) im Browser verglichen. DG OS zeigt Accounts, die nicht zurückfolgen, berücksichtigt eine Whitelist und führt durch eine Cleanup-Queue.\n\nDas eigentliche Entfolgen wird nicht automatisiert. Über „Instagram-Profil öffnen“ öffnet DG OS den jeweiligen Account; die Entscheidung wird anschliessend im Hub als Behalten, Entfernt oder Später gespeichert. Importierte Listen und Cleanup-Entscheidungen bleiben lokal im Browser.\n